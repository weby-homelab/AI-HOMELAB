...
2. Напишіть на email: **rekvizitor.ua@gmail.com** з темою `[SECURITY] AI-HomeLab`
...
- **Дозволені джерела:** Meta (LLaMA), Google (Gemma), Mistral, Microsoft (Phi), Anthropic (Claude)
