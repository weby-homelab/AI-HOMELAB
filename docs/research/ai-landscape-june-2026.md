...
*   **Нативне аудіо (Native Audio):**
    *   **Gemma 3n (E2B-IT):** Мала модель (Edge-класу) від Google, яка підтримує повний спектр вхідних даних (Текст + Зображення + Аудіо + Відео). Вона оптимізована для мобільних та вбудованих пристроїв і дозволяє реалізувати direct speech-to-speech сценарії без додаткових Whisper-моделей.
...
*   **Локальний Vision-інференс:**
    *   **Gemma 3 (12B/27B) / Gemma 4 31B:** Забезпечують видатну точність OCR, аналізу графіків та просторового розуміння зображень.
...
2. **Шар локального інференсу (Ollama / vLLM / llama.cpp)**:
   - Виконує локальні відкриті моделі (Gemma 3/4, Phi-4, LLaMA 4 Scout) на домашньому залізі.
