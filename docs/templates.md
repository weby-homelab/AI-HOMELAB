...
* **Гібридний пошук (Hybrid Memory Retrieval):**
   ...
   * **Ключовий фолбек (Keyword search):** Якщо сервіс Ollama тимчасово недоступний (наприклад, під час блекауту при роботі на резервному живленні), система автоматично перемикається на повнотекстовий пошук SQLite FTS5.
